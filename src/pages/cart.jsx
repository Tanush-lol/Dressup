      ...
      <div>
        {
          cartData.map((item,index)=>{
            ...
            return(
              <div key={index} className='py-4 border-t border-gray-500 border-b text-gray-700 grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
                <div className='flex items-start gap-6'>
                  ...
                  <div>
                    ...
                    <div className='flex items-center gap-5 mt-2'>
                      ...
                      <p className='px-2 sm:px-3 sm:py-1 broder bg-slate-200'>{item.size}</p>
