        ...
        <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' :'w-0' }`}>
          ...
          <div className='flex flex-col text-gray-600'>
            ...
            <div onClick={()=>setVisible(false)} className='flex items-center gap-3 p-3 cursor-pointer'>
              ...
              <img src={assets.dropdown_icon} className='w-2 l-2' alt = "dropdown"/>
              <p>Back</p>

            </div>

            <NavLink onClick={()=>setVisible(false)} className='py-2 pl-6 m-1' to='/'>Home</NavLink>
            <NavLink onClick={()=>setVisible(false)} className='py-2 pl-6 m-1' to='/collection'>Collection</NavLink>
            <NavLink onClick={()=>setVisible(false)} className='py-2 pl-6 m-1' to='/about'>About</NavLink>
            <NavLink onClick={()=>setVisible(false)} className='py-2 pl-6 m-1' to='/contact'>Contact</NavLink>
